		...
		<div className="container absolute left-0 right-0 top-0 bottom-0 max-w-none min-h-[800px] sm:min-h-[1000px]">
			...
			<div className="container-form-signin rounded-md h-fit w-fit mx-auto relative z-10">
				<div className="form-signin w-full h-fit">
					{/*  */}
					<h1 className="font-bold text-white text-[30px]">Log In</h1>
					{/* Email */}
					<div
						onClick={() => {
					...
					>
						...
						<input
							...
							className="input-email h-[90%] text-[20px] ml-[20px] relative hidden"
						/>
					</div>
					...
					>
						...
						<input
							...
							className="input-password h-[90%] text-[20px] ml-[20px] relative hidden"
						/>
					</div>
					{/*  */}
					...
					>
						<h1 className="text-[20px] mx-auto my-auto">Log In</h1>
					</button>
					{/*  */}
					...
					<div className="flex mx-auto w-fit">
						<h1 className="text-white h-[30px]">Sign up for an account?</h1>
						<Link to="/signup" className="text-blue-500 mx-[5px] font-bold cursor-pointer">
							Sign Up
						</Link>
					</div>
					{/*  */}
